...
import SwiftUI
struct KymaToggleStyle:ToggleStyle {
    var icon:String = ""
    var size:KymaToggleSize = .Large
    var onBackgound:Color = Color(KymaColor: .Blue3)
    var offBackground:Color = Color(KymaColor: .Gray11)
    var iconOnColor:Color = Color(KymaColor: .Blue3)
    var iconOffColor:Color = Color(KymaColor: .Gray8)
