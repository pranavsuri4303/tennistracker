...
import SwiftUI
class KymaLineDatasets: ObservableObject {
    @Published var datasets:[KymaLineChartDataset]
    ...
    init(datasets:[KymaLineChartDataset], dataStep:CGFloat, beginAtZero:Bool = false) {
