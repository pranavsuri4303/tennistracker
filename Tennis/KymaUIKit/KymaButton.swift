...
struct KymaButton: View {
    ...
    @State var size:KymaButtonSize = .Medium
    @State var state:KymaButtonState = .Default
    @State var type:KymaButtonType = .Primary
    @State var background:Color = Color(KymaColor: .Blue)
    @State var foregroundColor:Color = Color(.white)
    @State var defaultBorderColor:Color = Color(KymaColor: .Gray11)
