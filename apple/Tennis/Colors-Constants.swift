...
internal enum Colors {
  ...
  internal static let scSelectedBackground = ColorAsset(name: "sc-selected-background")
  internal static let scSelectedFont = ColorAsset(name: "sc-selected-font")
  internal static let scUnselectedBackground = ColorAsset(name: "sc-unselected-background")
  internal static let scUnselectedFont = ColorAsset(name: "sc-unselected-font")
