...
struct NewBaseView: View {
    @ObservedObject var vm = NewBaseViewVM()
    ...
    var body: some View {
        ...
        HStack(spacing: 0, content: {
            ...
            TabView(selection: $vm.currentTab) {
                BaseNavigationView(showMenu: $showMenu) {
...
struct BaseNavigationView<Content: View>: View {
    ...
    @EnvironmentObject var baseVM: NewBaseViewVM
