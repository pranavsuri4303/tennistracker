...
class KymaDateManager: ObservableObject {
    ...
    @Published var colors = KymaColorSettings()
    var cellWidth:CGFloat = 40
    
    init(calendar: Calendar, minimumDate: Date, maximumDate: Date, disabledDates:[Date] = [Date](), selectedDate:Date? = nil, selectedDates: [Date] = [Date](), mode: Int, colors:KymaColorSettings = KymaColorSettings(), cellWidth:CGFloat = 40) {
