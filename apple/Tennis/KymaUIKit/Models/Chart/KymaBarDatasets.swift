...
import SwiftUI
class KymaBarDatasets: ObservableObject {
    @Published var datasets:[KymaBarChartDataset]
    ...
    init(datasets:[KymaBarChartDataset], dataStep:CGFloat) {
