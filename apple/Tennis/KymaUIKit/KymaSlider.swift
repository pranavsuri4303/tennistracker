...
struct KymaSlider: View {
    ...
    var primaryColor:Color = Color(KymaColor: .Blue3)
    ...
    var body: some View {
                        ...
                        VStack {
                            ZStack {
                                RoundedRectangle(cornerRadius: 8)
                                    ...
                                    .overlay(
                                        RoundedRectangle(cornerRadius: 8)
                                            .strokeBorder(isDragging ? primaryColor : Color(KymaColor: .Gray12), lineWidth: isDragging ? 2 : 1)
                                    )
        ...
        //                RoundedRectangle(cornerRadius: 100)
        //                    .frame(height:4)
        //                    .foregroundColor(Color(KymaColor: .Gray11))
                        HStack(spacing: 0) {
                            RoundedRectangle(cornerRadius: 100)
    ...
    //                    if isDragging {
    //                        GeometryReader { KymaTooltipGeometry in
    //                            KymaTooltip(text: "\(value)", tooltipAlign: .Top, arrowAlign: .Center)
    //                                .frame(width: 100)
