...
struct KymaNumberInput: View {
    @Binding var value:Int
    @Binding var helperText:String
    @State var label:String? = nil
    
    @Binding var state:KymaNumberInputState
    @State var controls:KymaNumberInputControls = .LeftRight
    
    @State var decreaseIcon:String
    @State var increaseIcon:String
    
    var labelColor: Color = Color(KymaColor: .Gray8)
    var valueColor: Color = Color(KymaColor: .Gray2)
    
    var helperTextColor: Color = Color(KymaColor: .Gray8)
    
    var controlsColor: Color = Color(KymaColor: .Gray2)
