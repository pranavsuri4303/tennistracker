...
internal enum Icons {
  ...
  internal static let barChart = SymbolAsset(name: "bar-chart")
  ...
  internal static let female = SymbolAsset(name: "female")
  internal static let flag = SymbolAsset(name: "flag")
  internal static let ghost = SymbolAsset(name: "ghost")
  internal static let home = SymbolAsset(name: "home")
  internal static let lock = SymbolAsset(name: "lock")
  internal static let male = SymbolAsset(name: "male")
  ...
  internal static let tick = SymbolAsset(name: "tick")
