...
struct AnaliticsTemplate: View {
    ...
    var devicesChart: XelaPieDatasets = .init(dataset: XelaPieChartDataset(label: "statuses", data: [44, 24, 14, 18], fillColors: [Color(xelaColor: .Yellow5), Color(xelaColor: .Blue5), Color(xelaColor: .Red5), Color(xelaColor: .Purple5)]))
