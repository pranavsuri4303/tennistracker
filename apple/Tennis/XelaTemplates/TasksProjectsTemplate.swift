...
struct TasksProjectsTemplate: View {
    ...
    var statusesChart:XelaPieDatasets = XelaPieDatasets(dataset: XelaPieChartDataset(label: "statuses", data: [49, 57, 23, 18], fillColors: [Color(xelaColor: .Blue5), Color(xelaColor: .Purple5), Color(xelaColor: .Green2), Color(xelaColor: .Orange5)]))
...
@ViewBuilder
func TaskViewSubItem(task:Task, isDark:Bool) -> some View {
    HStack(spacing:16) {
        ZStack {
