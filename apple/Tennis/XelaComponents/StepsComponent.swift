...
struct StepsComponent: View {
    @StateObject var steps1: XelaStepsItems = .init(items: [XelaStepItem(id: 1, title: "Title", caption: "Caption"), XelaStepItem(id: 2, title: "Title", caption: "Caption", state: .Completed), XelaStepItem(id: 3, title: "Title", caption: "Caption", state: .Error), XelaStepItem(id: 4, title: "Title", caption: "Caption", state: .Active)])

    @StateObject var steps2: XelaStepsItems = .init(items: [XelaStepItem(id: 1, title: "Step 1", caption: "Basic information"), XelaStepItem(id: 2, title: "Step 2", caption: "User managment"), XelaStepItem(id: 3, title: "Step 3", caption: "Fleet settings"), XelaStepItem(id: 4, title: "Step 4", caption: "Confirmation")])
