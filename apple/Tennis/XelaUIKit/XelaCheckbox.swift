...
struct XelaCheckbox: View {
    ...
    var caption: String = ""
    var value: String = ""
    var selectedColor: Color = .init(xelaColor: .Blue3)
    var defaultColor: Color = .init(xelaColor: .Gray11)
    var valueColor: Color = .init(xelaColor: .Red3)
    ...
    var labelColor: Color = .init(xelaColor: .Gray2)
    var captionColor: Color = .init(xelaColor: .Gray8)
