...
struct XelaToggleStyle: ToggleStyle {
    ...
    var onBackgound: Color = .init(xelaColor: .Blue3)
    var offBackground: Color = .init(xelaColor: .Gray11)
    var iconOnColor: Color = .init(xelaColor: .Blue3)
    var iconOffColor: Color = .init(xelaColor: .Gray8)
    var circleOnColor: Color = .init(.white)
    var circleOffColor: Color = .init(.white)
